...
int32_t main()
{
    ...
    if(w=="szaka")
    {
        cout<<"Litwo, Ojczyzno moja! ty jestes jak zdrowie; Ile cie trzeba cenic, ten tylko się dowie, Kto cie stracil. Dzis pieknosc twa w calej ozdobie Widze i opisuje, bo tesknie po tobie.";
        return 0;
    }
    else
        a = stoi(w);
