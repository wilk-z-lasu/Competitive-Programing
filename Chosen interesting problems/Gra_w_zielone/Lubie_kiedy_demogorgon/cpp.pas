{
  Zadanie:           Gra w zielone
  Autor rozwi±zania: Tomasz Waleń
  Opis rozwi±zania:  rozwi±zanie O(k*(m+n))
}
program gra;
const
   f_in	 = '';
...
{zaznaczenie wszystkich wierzchołków z których
 I gracz może wymusić doj¶cie do zielonego wierzchołka}
procedure mark_v;
var
   qh,qt : integer;
...
begin  
   ...
   Writeln(j);
   for i:=1 to n do if s[i]=1 then Writeln(i);
end; { write_answer }
